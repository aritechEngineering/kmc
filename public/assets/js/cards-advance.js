...
!(function () {
  let o, t, r, e;
  t = (isDarkStyle ? ((o = config.colors_dark.cardColor), (e = config.colors_dark.textMuted), (r = config.colors_dark.bodyColor), config.colors_dark) : ((o = config.colors.cardColor), (e = config.colors.textMuted), (r = config.colors.bodyColor), config.colors)).headingColor;
