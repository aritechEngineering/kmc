...
!(function () {
  ...
  t &&
    (t.onclick = function () {
      var t,
        e,
        a = new Shepherd.Tour({ defaultStepOptions: { scrollTo: !1, cancelIcon: { enabled: !0 } }, useModalOverlay: !0 });
      (t = "btn btn-sm btn-label-secondary md-btn-flat waves-effect waves-light"),
