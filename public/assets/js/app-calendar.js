  ...
  document.addEventListener("DOMContentLoaded", function () {
    {
      ...
      function s() {
        ...
        e.setAttribute("data-bs-toggle", "sidebar"), e.setAttribute("data-overlay", ""), e.setAttribute("data-target", "#app-calendar-sidebar"), e.insertAdjacentHTML("beforeend", '<i class="ti ti-menu-2 ti-lg text-heading"></i>');
      }
      x.length &&
      ...
      FormValidation.formValidation(c, {
        fields: { eventTitle: { validators: { notEmpty: { message: "Please enter event title " } } }, eventStartDate: { validators: { notEmpty: { message: "Please enter start date " } } }, eventEndDate: { validators: { notEmpty: { message: "Please enter end date " } } } },
        plugins: {
        ...
        y.addEventListener("click", (e) => {
          var t, n;
          y.classList.contains("btn-add-event") ? r && ((n = { id: i.getEvents().length + 1, title: E.value, start: k.value, end: w.value, startStr: k.value, endStr: w.value, display: "block", extendedProps: { location: P.value, guests: D.val(), calendar: x.val(), description: M.value } }), q.value && (n.url = q.value), T.checked && (n.allDay = !0), (n = n), l.push(n), i.refetchEvents(), C.hide()) : r && ((n = { id: a.id, title: E.value, start: k.value, end: w.value, url: q.value, extendedProps: { location: P.value, guests: D.val(), calendar: x.val(), description: M.value }, display: "block", allDay: !!T.checked }), ((t = n).id = parseInt(t.id)), (l[l.findIndex((e) => e.id === t.id)] = t), i.refetchEvents(), C.hide());
        }),
