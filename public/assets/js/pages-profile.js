    ...
    (e.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          searchable: !1,
          render: function (e, a, t, s) {
            for (var r = t.team, l = "", i = 0, n = 0; n < r.length && ((l += '<li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kim Karlos" class="avatar avatar-sm pull-up"><img class="rounded-circle" src="' + assetsPath + "img/avatars/" + r[n] + '"  alt="Avatar"></li>'), !(2 < ++i)); n++);
            return 2 < i && 0 < (t = r.length - 3) && (l += '<li class="avatar avatar-sm"><span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip" data-bs-placement="top" title="' + t + ' more">+' + t + "</span ></li>"), '<div class="d-flex align-items-center"><ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">' + l + "</ul></div>";
          },
        },
        {
          targets: -2,
          render: function (e, a, t, s) {
            t = t.status;
            return '<div class="d-flex align-items-center"><div class="progress w-100 me-3" style="height: 6px;"><div class="progress-bar" style="width: ' + t + '" aria-valuenow="' + t + '" aria-valuemin="0" aria-valuemax="100"></div></div><span class="text-heading">' + t + "</span></div>";
          },
        },
        {
          targets: -1,
