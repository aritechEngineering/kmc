  ...
  document.addEventListener("DOMContentLoaded", function (e) {
    {
      const t = document.getElementById("formValidationExamples"),
        ...
        r = FormValidation.formValidation(t, {
          fields: {
            formValidationName: { validators: { notEmpty: { message: "Please enter your name" }, stringLength: { min: 6, max: 30, message: "The name must be more than 6 and less than 30 characters long" }, regexp: { regexp: /^[a-zA-Z0-9 ]+$/, message: "The name can only consist of alphabetical, number and space" } } },
      ...
      a &&
        ...
        o.length &&
          ...
          o.select2({ placeholder: "Select country", dropdownParent: o.parent() }).on("change", function () {
