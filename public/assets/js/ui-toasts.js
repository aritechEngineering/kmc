...
!(function () {
  ...
  t &&
    (t.onclick = function () {
      l && c(l), (a = document.querySelector("#selectType").value), (n = document.querySelector("#selectAnimation").value), e.classList.add(n), e.querySelector(".ti").classList.add(a), (l = new bootstrap.Toast(e)).show();
    }),
    s &&
      (s.onclick = function () {
        r && c(r), (a = document.querySelector("#selectTypeOpt").value), (i = document.querySelector("#selectPlacement").value.split(" ")), o.querySelector(".ti").classList.add(a), DOMTokenList.prototype.add.apply(o.classList, i), (r = new bootstrap.Toast(o)).show();
      });
})(),
  $(function () {
    var f,
    ...
    $("#closeButton").on("click", function () {
      ...
      $("#showtoast").on("click", function () {
        var t = $("#toastTypeGroup input:radio:checked").val(),
          ...
          v = void 0 === toastr.options.positionClass ? "toast-top-right" : toastr.options.positionClass,
          o =
            ((toastr.options = { maxOpened: 1, autoDismiss: !0, closeButton: $("#closeButton").prop("checked"), debug: $("#debugInfo").prop("checked"), newestOnTop: $("#newestOnTop").prop("checked"), progressBar: $("#progressBar").prop("checked"), positionClass: $("#positionGroup input:radio:checked").val() || "toast-top-right", preventDuplicates: $("#preventDuplicates").prop("checked"), onclick: null, rtl: e }),
            v != toastr.options.positionClass && ((toastr.options.hideDuration = 0), toastr.clear()),
