  ...
  a.length &&
    a.DataTable({
      ...
      columnDefs: [
        {
          ...
          render: function (e, t, a, s) {
            ...
            return void 0 === l[a] ? e : '<span class="badge ' + l[a].class + '">' + l[a].title + "</span>";
          },
        },
        {
          targets: -1,
      ...
      initComplete: function (e, t) {
        a.find("tbody tr:first").addClass("border-top-0"), $(".card-header").after('<hr class="my-0">');
      },
    }),
    t.length &&
      ((t = t.DataTable({
          ...
          { targets: 2, visible: !1 },
          {
            ...
            render: function (e, t, a, s) {
              var l = a.avatar,
                i = a.full_name,
                r = a.post;
              return '<div class="d-flex justify-content-start align-items-center"><div class="avatar-wrapper"><div class="avatar me-2">' + (l ? '<img src="' + assetsPath + "img/avatars/" + l + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (l = (((l = (i = a.full_name).match(/\b\w/g) || []).shift() || "") + (l.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><span class="emp_name text-truncate">' + i + '</span><small class="emp_post text-truncate text-muted">' + r + "</small></div></div>";
            },
      ...
      window.Helpers.isNavbarFixed() ? ((e = $("#layout-navbar").outerHeight()), new $.fn.dataTable.FixedHeader(t).headerOffset(e)) : new $.fn.dataTable.FixedHeader(t)),
    s.length &&
      s.DataTable({
        ajax: assetsPath + "json/table-datatable.json",
