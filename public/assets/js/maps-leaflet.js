...
!(function () {
  var e = {
    ...
    t = (document.getElementById("basicMap") && ((t = L.map("basicMap").setView([42.35, -71.08], 10)), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(t)), document.getElementById("shapeMap")),
    t =
      (t &&
        ((t = L.map("shapeMap").setView([51.5, -0.09], 12)),
        L.marker([51.5, -0.09]).addTo(t),
        L.circle([51.508, -0.11], { color: "red", fillColor: "#f03", fillOpacity: 0.5, radius: 500 }).addTo(t),
        L.polygon([
          [51.509, -0.08],
          [51.503, -0.06],
          [51.51, -0.047],
        ]).addTo(t),
        L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(t)),
      document.getElementById("dragMap")),
    t = (t && ((t = L.map("dragMap").setView([48.817152, 2.455], 12)), L.marker([48.817152, 2.455], { draggable: "true" }).addTo(t).bindPopup("<b>You're here!</b>").openPopup(), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(t)), document.getElementById("userLocation"));
  if (t) {
    ...
    i.locate({ setView: !0, maxZoom: 16 }),
      ...
      L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(i);
  }
  document.getElementById("customIcons") && ((t = L.map("customIcons").setView([51.5, -0.09], 10)), (o = L.icon({ iconUrl: assetsPath + "img/icons/misc/leaf-green.png", shadowUrl: assetsPath + "img/icons/misc/leaf-shadow.png", iconSize: [38, 95], shadowSize: [50, 64], iconAnchor: [22, 94], shadowAnchor: [4, 62], popupAnchor: [-3, -76] })), (a = L.icon({ iconUrl: assetsPath + "img/icons/misc/leaf-red.png", shadowUrl: assetsPath + "img/icons/misc/leaf-shadow.png", iconSize: [38, 95], shadowSize: [50, 64], iconAnchor: [22, 94], shadowAnchor: [4, 62], popupAnchor: [-3, -76] })), (r = L.icon({ iconUrl: assetsPath + "img/icons/misc/leaf-orange.png", shadowUrl: assetsPath + "img/icons/misc/leaf-shadow.png", iconSize: [38, 95], shadowSize: [50, 64], iconAnchor: [22, 94], shadowAnchor: [4, 62], popupAnchor: [-3, -76] })), L.marker([51.5, -0.09], { icon: a }).addTo(t), L.marker([51.4, -0.51], { icon: o }).addTo(t), L.marker([51.49, -0.45], { icon: r }).addTo(t), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(t));
  var o,
    r,
  ...
  a &&
    ...
    L.geoJson(e, {
      style: function (e) {
        return { fillColor: 1e3 < (e = e.properties.density) ? "#800026" : 500 < e ? "#BD0026" : 200 < e ? "#E31A1C" : 100 < e ? "#FC4E2A" : 50 < e ? "#FD8D3C" : 20 < e ? "#FEB24C" : 10 < e ? "#FED976" : "#FFEDA0", weight: 2, opacity: 1, color: "white", dashArray: "3", fillOpacity: 0.7 };
      },
    }).addTo(o),
    L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(o)),
    document.getElementById("layerControl") && ((r = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO.")), (t = L.marker([39.74, -104.99]).bindPopup("This is Denver, CO.")), (a = L.marker([39.73, -104.8]).bindPopup("This is Aurora, CO.")), (e = L.marker([39.77, -105.23]).bindPopup("This is Golden, CO.")), (o = L.layerGroup([r, t, a, e])), (r = L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", { maxZoom: 18, attribution: "© OpenStreetMap" })), (t = L.tileLayer("https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png", { maxZoom: 19, attribution: "© OpenStreetMap contributors, Tiles style by Humanitarian OpenStreetMap Team hosted by OpenStreetMap France" })), (a = L.map("layerControl", { center: [39.73, -104.99], zoom: 10, layers: [r, o] })), L.control.layers({ OpenStreetMap: r, "OpenStreetMap.HOT": t }, { Cities: o }).addTo(a), L.tileLayer("https://c.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(a));
})();
