...
!(function () {
  ...
  e && autosize(e),
    ...
    a && new Cleave(a, { date: !0, delimiter: "-", datePattern: ["Y", "m", "d"] }),
    ...
    c && new Cleave(c, { delimiters: [".", ".", "-"], blocks: [3, 3, 3, 2], uppercase: !0 }),
  ...
  $(function () {
    ...
    e.length &&
      e.each(function () {
        $(this).maxlength({ warningClass: "label label-success bg-success text-white", limitReachedClass: "label label-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", validate: !0, threshold: +this.getAttribute("maxlength") });
      }),
      t.length &&
        ((n = 2),
        (o = 1),
