...
!(function () {
  ...
  var s = document.querySelector("#swiper-with-pagination-cards"),
    s = (s && new Swiper(s, { loop: !0, autoplay: { delay: 2500, disableOnInteraction: !1 }, pagination: { clickable: !0, el: ".swiper-pagination" } }), document.querySelector("#averageDailySales")),
    i = {
      chart: { height: 105, type: "area", toolbar: { show: !1 }, sparkline: { enabled: !0 } },
  ...
  s.length &&
    (s.DataTable({
      ...
      language: { search: "", searchPlaceholder: "Search Project", paginate: { next: '<i class="ti ti-chevron-right ti-sm"></i>', previous: '<i class="ti ti-chevron-left ti-sm"></i>' } },
      responsive: {
        details: {
