...
document.addEventListener("DOMContentLoaded", function () {
  {
    ...
    if (
      (r && new PerfectScrollbar(r, { wheelPropagation: !1, suppressScrollX: !0 }),
      c && new PerfectScrollbar(c, { wheelPropagation: !1, suppressScrollX: !0 }),
      s && new PerfectScrollbar(s, { wheelPropagation: !1, suppressScrollX: !0 }),
      n && new Quill(".email-editor", { modules: { toolbar: ".email-editor-toolbar" }, placeholder: "Message ", theme: "snow" }),
      p && new Quill(".email-reply-editor", { modules: { toolbar: ".email-reply-toolbar" }, placeholder: "Write your message... ", theme: "snow" }),
      v &&
        v.forEach((e) => {
      ...
      g &&
        g.addEventListener("click", (e) => {
          e.currentTarget.checked ? o.forEach((e) => (e.checked = 1)) : o.forEach((e) => (e.checked = 0));
        }),
      o &&
        o.forEach((e) => {
          e.addEventListener("click", (e) => {
            ...
            o.forEach((e) => {
              ...
              t < o.length ? (0 == t ? (g.indeterminate = !1) : (g.indeterminate = !0)) : t == o.length ? ((g.indeterminate = !1), (g.checked = !0)) : (g.indeterminate = !1);
          });
        }),
      h &&
      ...
      k.addEventListener("hidden.bs.modal", (e) => {
        (document.querySelector(".email-editor .ql-editor").innerHTML = ""), $("#emailContacts").val(""), a();
      }),
      f &&
      ...
      let t = $(".email-list"),
        l = new PerfectScrollbar(r, { wheelPropagation: !1, suppressScrollX: !0 });
