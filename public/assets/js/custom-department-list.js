    ...
    o.length &&
      ...
      s.length &&
        (s.DataTable({
          ...
          language: { sLengthMenu: "_MENU_", search: "", searchPlaceholder: "Search Department", paginate: { next: '<i class="ti ti-chevron-right ti-sm"></i>', previous: '<i class="ti ti-chevron-left ti-sm"></i>' } },
          buttons: [{ text: '<i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Department</span>', className: "add-new btn btn-primary ms-2 waves-effect waves-light", attr: { "data-bs-toggle": "offcanvas", "data-bs-target": "#administrationDepartmentList" } }],
          responsive: {
            details: {
