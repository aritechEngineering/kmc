...
document.addEventListener("DOMContentLoaded", function (e) {
  var n;
  (n = document.querySelector(".phone-number-otp-mask")) && new Cleave(n, { phone: !0, phoneRegionCode: "US" }),
    FormValidation.formValidation(document.getElementById("enableOTPForm"), {
      fields: { modalEnableOTPPhone: { validators: { notEmpty: { message: "Please enter your mobile number" } } } },
