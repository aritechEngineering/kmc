...
$(function () {
  var o,
    ...
    e =
      ...
      new Bloodhound({ datumTokenizer: Bloodhound.tokenizers.whitespace, queryTokenizer: Bloodhound.tokenizers.whitespace, local: e })),
    t = ($(".typeahead-bloodhound").typeahead({ hint: !isRtl, highlight: !0, minLength: 1 }, { name: "states", source: e }), new Bloodhound({ datumTokenizer: Bloodhound.tokenizers.whitespace, queryTokenizer: Bloodhound.tokenizers.whitespace, prefetch: assetsPath + "json/typeahead.json" }));
  $(".typeahead-prefetch").typeahead({ hint: !isRtl, highlight: !0, minLength: 1 }, { name: "states", source: t }),
  ...
  var e = new Bloodhound({ datumTokenizer: Bloodhound.tokenizers.obj.whitespace("value"), queryTokenizer: Bloodhound.tokenizers.whitespace, prefetch: assetsPath + "json/typeahead-data-2.json" }),
    e =
  ...
  $(".typeahead-multi-datasets").typeahead({ hint: !isRtl, highlight: !0, minLength: 0 }, { name: "nba-teams", source: e, display: "team", templates: { header: '<h5 class="league-name border-bottom mb-0 mx-3 mt-3 pb-2">NBA Teams</h5>' } }, { name: "nhl-teams", source: a, display: "team", templates: { header: '<h5 class="league-name border-bottom mb-0 mx-3 mt-3 pb-2">NHL Teams</h5>' } });
});
