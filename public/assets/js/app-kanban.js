...
!(async function () {
  ...
  const v = new jKanban({
      ...
      click: function (e) {
        ...
        s.show(), (r.querySelector("#title").value = a), (r.querySelector("#due-date").nextSibling.value = n), $(".kanban-update-item-sidebar").find(o).val(i).trigger("change"), (r.querySelector(".assigned").innerHTML = ""), r.querySelector(".assigned").insertAdjacentHTML("afterbegin", p(d, !1, "xs", "1", e.getAttribute("data-members")) + "<div class='avatar avatar-xs ms-1'><span class='avatar-initial rounded-circle bg-label-secondary'><i class='ti ti-plus ti-xs text-heading'></i></span></div>");
      },
  ...
  k &&
    k.forEach(function (e) {
      ...
      let i = "";
      null !== e.getAttribute("data-image") && (i = "<img class='img-fluid rounded mb-2' src='" + l + "img/elements/" + e.getAttribute("data-image") + "'>"), (e.textContent = ""), void 0 !== e.getAttribute("data-badge") && void 0 !== e.getAttribute("data-badge-text") && e.insertAdjacentHTML("afterbegin", ((t = e.getAttribute("data-badge")), (a = e.getAttribute("data-badge-text")), "<div class='d-flex justify-content-between flex-wrap align-items-center mb-2'><div class='item-badges'> <div class='badge bg-label-" + t + "'> " + a + "</div></div>" + m() + "</div>" + i + n)), (void 0 === e.getAttribute("data-comments") && void 0 === e.getAttribute("data-due-date") && void 0 === e.getAttribute("data-assigned")) || e.insertAdjacentHTML("beforeend", ((t = e.getAttribute("data-attachments")), (a = e.getAttribute("data-comments")), (n = e.getAttribute("data-assigned")), (e = e.getAttribute("data-members")), "<div class='d-flex justify-content-between align-items-center flex-wrap mt-2'><div class='d-flex'> <span class='d-flex align-items-center me-2'><i class='ti ti-paperclip me-1'></i><span class='attachments'>" + t + "</span></span> <span class='d-flex align-items-center ms-2'><i class='ti ti-message-2 me-1'></i><span> " + a + " </span></span></div><div class='avatar-group d-flex align-items-center assigned-avatar'>" + p(n, !0, "xs", null, e) + "</div></div>"));
    });
