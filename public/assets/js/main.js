...
document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
  (function () {
    setTimeout(function () {
      ...
      "undefined" != typeof Waves && (Waves.init(), Waves.attach(".btn[class*='btn-']:not(.position-relative):not([class*='btn-outline-']):not([class*='btn-label-'])", ["waves-light"]), Waves.attach("[class*='btn-outline-']:not(.position-relative)"), Waves.attach("[class*='btn-label-']:not(.position-relative)"), Waves.attach(".pagination .page-item .page-link"), Waves.attach(".dropdown-menu .dropdown-item"), Waves.attach(".light-style .list-group .list-group-item-action"), Waves.attach(".dark-style .list-group .list-group-item-action", ["waves-light"]), Waves.attach(".nav-tabs:not(.nav-tabs-widget) .nav-item .nav-link"), Waves.attach(".nav-pills .nav-item .nav-link", ["waves-light"])),
    ...
    var n,
      ...
      a =
        (window.templateCustomizer &&
          ...
          (a = a.querySelector("i")),
          "light" === o ? (a.classList.add("ti-sun"), new bootstrap.Tooltip(a, { title: "Light Mode", fallbackPlacements: ["bottom"] })) : "dark" === o ? (a.classList.add("ti-moon-stars"), new bootstrap.Tooltip(a, { title: "Dark Mode", fallbackPlacements: ["bottom"] })) : (a.classList.add("ti-device-desktop-analytics"), new bootstrap.Tooltip(a, { title: "System Mode", fallbackPlacements: ["bottom"] }))),
        "system" === (n = o) && (n = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"),
    ...
    if (
      ...
      !isHorizontalLayout && !window.Helpers.isSmallScreen() && ("undefined" != typeof TemplateCustomizer && (window.templateCustomizer.settings.defaultMenuCollapsed ? window.Helpers.setCollapsed(!0, !1) : window.Helpers.setCollapsed(!1, !1)), "undefined" != typeof config) && config.enableMenuLocalStorage)
    )
      try {
      ...
      s.length &&
        ...
        o.length &&
          ...
          o.each(function () {
            ...
            o
              .typeahead(
                { hint: !1, classNames: { menu: "tt-menu navbar-search-suggestion", cursor: "active", suggestion: "suggestion d-flex justify-content-between px-4 py-2 w-100" } },
                {
                  name: "pages",
                  display: "name",
                  limit: 5,
