...
$(function () {
  ...
  a.length &&
    (e = a.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          orderable: !1,
          render: function (e, a, t, s) {
            for (var n = t.assigned_to, r = "", o = { Admin: '<a href="' + d + '"><span class="badge me-4 bg-label-primary">Administrator</span></a>', Manager: '<a href="' + d + '"><span class="badge me-4 bg-label-warning">Manager</span></a>', Users: '<a href="' + d + '"><span class="badge me-4 bg-label-success">Users</span></a>', Support: '<a href="' + d + '"><span class="badge me-4 bg-label-info">Support</span></a>', Restricted: '<a href="' + d + '"><span class="badge me-4 bg-label-danger">Restricted User</span></a>' }, i = 0; i < n.length; i++) r += o[n[i]];
      ...
      language: { sLengthMenu: "Show _MENU_", search: "", searchPlaceholder: "Search Permissions", paginate: { next: '<i class="ti ti-chevron-right ti-sm"></i>', previous: '<i class="ti ti-chevron-left ti-sm"></i>' } },
      buttons: [
        {
    ...
    setTimeout(() => {
      $(".dataTables_filter .form-control").removeClass("form-control-sm"), $(".dataTables_length .form-select").removeClass("form-select-sm"), $(".dataTables_info").addClass("ms-n1"), $(".dataTables_paginate").addClass("me-n1");
    }, 300);
});
