                  ...
                  value: function (t) {
                    ...
                    if (this._hasControls("themes")) {
                      ...
                      if (s) {
                        ...
                        this._loadStylesheets(((a = {}), (n = r), (o = document.querySelector(".template-customizer-theme-css")), (n = g(n)) in a ? Object.defineProperty(a, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (a[n] = o), a), i || function () {}), e && this.settings.onSettingsChange.call(this, this.settings);
                      }
                    }
                  },
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (this._hasControls("headerType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                      ...
                      "fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType ? s && i && (window.Helpers.menuPsScroll.destroy(), (i = new s(document.querySelector(".menu-inner"), { suppressScrollX: !0, wheelPropagation: !1 })), (window.Helpers.menuPsScroll = i)) : i && window.Helpers.menuPsScroll.destroy();
                    }
                  },
                },
                {
