          ...
          document.querySelector(".content-wrapper > .menu-horizontal > div") && ((f = !0), (n = document.querySelector(".content-wrapper > .menu-horizontal > div"))),
            "compact" === t
              ? (u.some(function (e) {
                ...
                f && (e._removeClass("container-fluid", n), e._addClass("container-xxl", n), r && (e._removeClass("container-fluid", r), e._addClass("container-xxl", r)), s && (e._removeClass("container-fluid", s), e._addClass("container-xxl", s))))
              : (c.some(function (e) {
                  return [i, l].includes(e);
                ...
                f && (e._removeClass("container-xxl", n), e._addClass("container-fluid", n), r && (e._removeClass("container-xxl", r), e._addClass("container-fluid", r)), s && (e._removeClass("container-xxl", s), e._addClass("container-fluid", s))));
        }, 100);
      },
      update: function () {
        ...
        null != e &&
          e.forEach(function (e) {
            e.addEventListener("click", function (t) {
              ...
              "text" === o.getAttribute("type") ? (o.setAttribute("type", "password"), i.classList.replace("ti-eye", "ti-eye-off")) : "password" === o.getAttribute("type") && (o.setAttribute("type", "text"), i.classList.replace("ti-eye-off", "ti-eye"));
            });
          });
      },
