  ...
  return (function () {
    ...
    var ie = {
        ...
        fn: function (e) {
          var t = e.state,
            ...
            s = n.roundOffsets,
            c = void 0 === s || s,
            l = { placement: I(t.placement), variation: ee(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: r, isFixed: "fixed" === t.options.strategy };
        ...
        : ve(
            (function (e) {
              var t,
                ...
                s = -i.scrollLeft + fe(e),
                c = -i.scrollTop;
              return "rtl" === q(r || n).direction && (s += N(n.clientWidth, r ? r.clientWidth : 0) - o), { width: o, height: a, x: s, y: c };
            })(K(e))
          );
    }
    function ge(e) {
    ...
    function _e(e, t) {
      ...
      var n = t,
        ...
        I = ge({ reference: D, element: C, strategy: "absolute", placement: s }),
        F = ve(Object.assign({}, C, I)),
        H = b === p ? F : D,
        B = { top: P.top - H.top + O.top, bottom: H.bottom - P.bottom + O.bottom, left: P.left - H.left + O.left, right: H.right - P.right + O.right },
        ...
        if (!t.modifiersData[i]._skip) {
          for (
                  ...
                  I(n) === c
                    ? (function (e, t) {
                        ...
                        var p = h.reduce(function (t, n) {
                          return (t[n] = _e(e, { placement: n, boundary: r, rootBoundary: o, padding: a })[I(n)]), t;
                        }, {});
                        return Object.keys(p).sort(function (e, t) {
                          return p[e] - p[t];
                        });
                      })(t, { placement: n, boundary: y, rootBoundary: b, padding: _, flipVariations: E, allowedAutoPlacements: A })
                    : n
                );
              }, []),
              S = t.rects.reference,
            ...
            var M = x[N],
              ...
              B = [r, o].indexOf(F) >= 0,
              W = B ? "width" : "height",
              R = _e(t, { placement: M, boundary: y, rootBoundary: b, altBoundary: w, padding: _ }),
              z = B ? (H ? a : s) : H ? o : r;
            S[W] > L[W] && (z = se(z));
            var q = se(z),
              V = [];
      ...
      Oe = {
        ...
        fn: function (e) {
          var t = e.state,
            ...
            y = n.tetherOffset,
            b = void 0 === y ? 0 : y,
            w = _e(t, { boundary: h, rootBoundary: p, padding: m, altBoundary: v }),
            k = I(t.placement),
            E = ee(t.placement),
            A = !E,
            O = Y(k),
    ...
    function Te(e, t, n) {
      ...
      var i,
        ...
        u = { x: 0, y: 0 };
      return (o || (!o && !n)) && (("body" !== x(t) || de(s)) && (l = (i = t) !== S(i) && j(i) ? { scrollLeft: (r = i).scrollLeft, scrollTop: r.scrollTop } : ue(i)), j(t) ? (((u = W(t, !0)).x += t.clientLeft), (u.y += t.clientTop)) : s && (u.x = fe(s))), { x: c.left + l.scrollLeft - u.x, y: c.top + l.scrollTop - u.y, width: c.width, height: c.height };
    }
    function Ce(e) {
      var t = new Map(),
        n = new Set(),
    ...
    function Le(e) {
      ...
      return function (e, t, n) {
        ...
        var r,
          a,
          s = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, xe, o), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
          c = [],
          l = !1,
          u = {
            state: s,
            setOptions: function (n) {
              ...
              f(), (s.options = Object.assign({}, o, s.options, r)), (s.scrollParents = { reference: L(e) ? pe(e) : e.contextElement ? pe(e.contextElement) : [], popper: pe(t) });
              var a,
                l,
                d = (function (e) {
                  var t = Ce(e);
            ...
            forceUpdate: function () {
              if (!l) {
                var e = s.elements,
                  ...
                  n = e.popper;
                if (Se(t, n)) {
                  (s.rects = { reference: Te(t, X(n), "fixed" === s.options.strategy), popper: R(n) }),
                    (s.reset = !1),
        ...
        if (f) f.oneOff = f.oneOff && r;
          ...
          var d = Tt(s, t.replace(yt, "")),
            h = a
                  ...
                  return function i(r) {
                    for (var o = e.querySelectorAll(t), a = r.target; a && a !== this; a = a.parentNode) {
                      var s,
                        c = $e(o);
                      try {
                        for (c.s(); !(s = c.n()).done; ) if (s.value === a) return Nt(r, { delegateTarget: a }), i.oneOff && It.off(e, r.type, t, n), n.apply(a, [r]);
                      } catch (e) {
                        c.e(e);
                      } finally {
                        c.f();
              ...
              : (function (e, t) {
                  return function n(i) {
                    return Nt(i, { delegateTarget: e }), n.oneOff && It.off(e, i.type, t), t.apply(e, [i]);
                  };
                })(e, s);
      ...
      off: function (e, t, n, i) {
        if ("string" == typeof t && e) {
          var r = Ye(St(t, n, i), 3),
            ...
            f = t.startsWith(".");
          if (void 0 === a) {
            if (f) for (var d = 0, h = Object.keys(l); d < h.length; d++) Pt(e, l, h[d], t.slice(1));
    ...
    var tn = ".bs.swipe",
      ...
      jn = { interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0 },
      Pn = { interval: "(number|boolean)", keyboard: "boolean", pause: "(string|boolean)", ride: "(boolean|string)", touch: "boolean", wrap: "boolean" },
      Dn = (function (e) {
        function t(e, n) {
          var i;
                  ...
                  if (!this._isSliding) {
                    ...
                    if (o !== i) {
                      var a = this._getItemIndex(o),
                        s = function (n) {
                          return It.trigger(t._element, n, { relatedTarget: o, direction: t._orderToDirection(e), from: t._getItemIndex(i), to: a });
                        };
    ...
    var Xn = "dropdown",
      ...
      mi = { autoClose: !0, boundary: "clippingParents", display: "dynamic", offset: [0, 2], popperConfig: null, reference: "toggle" },
      gi = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" },
      _i = (function (e) {
        function t(e, n) {
          var i;
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (this._inNavbar || "static" === this._config.display) && (Ht(this._menu, "popper", "static"), (e.modifiers = [{ name: "applyStyles", enabled: !1 }])), qe(qe({}, e), mt(this._config.popperConfig, [e]));
                },
              },
              {
                key: "_selectMenuItem",
    ...
    var yi = "backdrop",
      ...
      ki = { className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body" },
      Ei = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" },
      Ai = (function (e) {
        function t(e) {
          var n;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  this._isShown ||
                    ...
                    It.trigger(this._element, Ri, { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
                    (this._isTransitioning = !0),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  n && (n.scrollTop = 0),
                    ...
                    this._queueCallback(
                      function () {
                        t._config.focus && t._focustrap.activate(), (t._isTransitioning = !1), It.trigger(t._element, zi, { relatedTarget: e });
                      },
                      this._dialog,
                      this._isAnimated()
                    );
    ...
    var er = ".".concat("bs.offcanvas"),
      ...
      mr = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" },
      gr = (function (e) {
        function t(e, n) {
          var i;
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this;
                  this._isShown ||
                    It.trigger(this._element, sr, { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
                    this._backdrop.show(),
                    ...
                    this._queueCallback(
                      function () {
                        (t._config.scroll && !t._config.backdrop) || t._focustrap.activate(), t._element.classList.add(ir), t._element.classList.remove(rr), It.trigger(t._element, cr, { relatedTarget: e });
                      },
                      this._element,
                      !0
                    ));
    ...
    It.on(document, hr, '[data-bs-toggle="offcanvas"]', function (e) {
      ...
      Qt(gr),
      vt(gr);
    var _r = { "*": ["class", "dir", "id", "lang", "role", /^aria-[\w-]*$/i], a: ["target", "href", "title", "rel"], area: [], b: [], br: [], col: [], code: [], dd: [], div: [], dl: [], dt: [], em: [], hr: [], h1: [], h2: [], h3: [], h4: [], h5: [], h6: [], i: [], img: ["src", "srcset", "alt", "title", "width", "height"], li: [], ol: [], p: [], pre: [], s: [], small: [], span: [], sub: [], sup: [], strong: [], u: [], ul: [] },
      ...
      kr = { allowList: _r, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
      Er = { allowList: "object", content: "object", extraClass: "(string|function)", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", template: "string" },
      Ar = { entry: "(string|element|function|null)", selector: "(string|element)" },
      Or = (function (e) {
        function t(e) {
          var n;
                ...
                value: function (e) {
                  for (var n = 0, i = Object.entries(e); n < i.length; n++) {
                    var r = Ye(i[n], 2),
                      o = r[0],
                      a = r[1];
                    Ie(He(t.prototype), "_typeCheckConfig", this).call(this, { selector: o, entry: a }, Ar);
                  }
                },
              },
              {
      ...
      jr = "hover",
      Pr = "focus",
      Dr = { AUTO: "auto", TOP: "top", RIGHT: pt() ? "left" : "right", BOTTOM: "bottom", LEFT: pt() ? "right" : "left" },
      Ir = { allowList: _r, animation: !0, boundary: "clippingParents", container: !1, customClass: "", delay: 0, fallbackPlacements: ["top", "right", "bottom", "left"], html: !1, offset: [0, 6], placement: "top", popperConfig: null, sanitize: !0, sanitizeFn: null, selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', title: "", trigger: "hover focus" },
      Nr = { allowList: "object", animation: "boolean", boundary: "(string|element)", container: "(string|element|boolean)", customClass: "(string|function)", delay: "(number|object)", fallbackPlacements: "array", html: "boolean", offset: "(array|string|function)", placement: "(string|function)", popperConfig: "(null|object|function)", sanitize: "boolean", sanitizeFn: "(null|function)", selector: "(string|boolean)", template: "string", title: "(string|element|function)", trigger: "string" },
      Mr = (function (e) {
        function t(e, i) {
          var r;
          ...
          Ue(
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  return this._templateFactory ? this._templateFactory.changeContent(e) : (this._templateFactory = new Or(qe(qe({}, this._config), {}, { content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) }))), this._templateFactory;
                },
              },
              {
              ...
              },
              {
                key: "_configAfterMerge",
                value: function (e) {
                  return (e.container = !1 === e.container ? document.body : at(e.container)), "number" == typeof e.delay && (e.delay = { show: e.delay, hide: e.delay }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), e;
                },
              },
              {
    ...
    vt(Mr);
    var Fr = qe(qe({}, Mr.Default), {}, { content: "", offset: [0, 8], placement: "right", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: "click" }),
      Hr = qe(qe({}, Mr.DefaultType), {}, { content: "(null|string|element|function)" }),
      Br = (function (e) {
        function t() {
          return Ke(this, t), Ne(this, t, arguments);
        }
    ...
    var Wr = ".".concat("bs.scrollspy"),
      ...
      Xr = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
      Yr = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element", threshold: "array" },
      $r = (function (e) {
        function t(e, n) {
          var i;
          return Ke(this, t), ((i = Ne(this, t, [e, n]))._targetLinks = new Map()), (i._observableSections = new Map()), (i._rootElement = "visible" === getComputedStyle(i._element).overflowY ? null : i._element), (i._activeTarget = null), (i._observer = null), (i._previousScrollData = { visibleEntryTop: 0, parentScrollTop: 0 }), i.refresh(), i;
        }
        return (
          We(t, e),
          Ue(
            ...
            [
              ...
              },
              {
                key: "_process",
                value: function (e) {
                  this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e), e.classList.add(Vr), this._activateParents(e), It.trigger(this._element, Rr, { relatedTarget: e }));
                },
              },
              {
            ...
            [
              {
                ...
                value: function () {
                  ...
                  if (!this._elemIsActive(e)) {
                    ...
                    It.trigger(e, eo, { relatedTarget: t }).defaultPrevented || (n && n.defaultPrevented) || (this._deactivate(t, e), this._activate(e, t));
                  }
                },
              },
              {
                ...
                value: function (e, t) {
                  ...
                  e &&
                    ...
                    this._queueCallback(
                      function () {
                        "tab" === e.getAttribute("role") ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), n._toggleDropDown(e, !0), It.trigger(e, to, { relatedTarget: t })) : e.classList.add(po);
                      },
                      e,
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  e &&
                    ...
                    this._queueCallback(
                      function () {
                        "tab" === e.getAttribute("role") ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), n._toggleDropDown(e, !1), It.trigger(e, Zr, { relatedTarget: t })) : e.classList.remove(po);
                      },
                      e,
                      e.classList.contains(ho)
                    ));
