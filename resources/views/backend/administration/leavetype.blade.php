        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">Leave Type Lists</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Leave Type</span></span>
                        </button>
                    </div>
                </div>
                <div class="card-datatable table-responsive">
                    <table class="dt-responsive table">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                <td><span class="fw-medium">Leave Type name</span></td>
                                <td>12</td>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="administrationBloodGroup" class="offcanvas-title">Add Leave Type</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="Enter Leave Type title" name="title" aria-label="Leave Type title" />
                        </div>
                        <!-- Days -->
                        <div class="mb-6">
