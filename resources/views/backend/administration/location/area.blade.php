                    ...
                    <table class="dt-responsive table">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                ...
                                <td><span class="fw-medium">Area name</span></td>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <div class="mb-6 ecommerce-select2-dropdown">
                            <label class="form-label" for="parent-country">Country</label>
                        ...
                        <!-- State -->
                        <div class="mb-6 ecommerce-select2-dropdown">
                            <label class="form-label" for="parent-state">State</label>
                            <select id="parent-state" class="select2 form-select" data-placeholder="Select state">
                        ...
                        <!-- Area -->
                        <div class="mb-6 ecommerce-select2-dropdown">
                            <label class="form-label" for="parent-area">Area</label>
                            <select id="parent-area" class="select2 form-select" data-placeholder="Select area">
