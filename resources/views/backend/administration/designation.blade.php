        ...
        <div class="app-ecommerce-category">
                ...
                <div class="card-datatable table-responsive">
                    <table class="dt-responsive table">
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                <td><span class="fw-medium">Designation name</span></td>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Blood Group</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="Enter Designation title" name="title" aria-label="designation title" />
                        </div>
                        <!-- Description -->
                        <div class="mb-6">
