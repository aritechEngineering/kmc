        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">Overtime Lists</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Overtime</span></span>
                        </button>
                    </div>
                </div>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Overtime</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        <div class="mb-6">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="Enter Overtime" name="title" />
                        </div>
                        <div class="mb-6 ecommerce-select2-dropdown">
                            <label class="form-label" for="employee">Rate Type</label>
                            <select id="employee" class="select2 form-select" data-placeholder="Select employee">
                                <option value="">Select Rate</option>
                                <option value="Household">Daily Rate</option>
                                <option value="Household">Hourly Rate</option>
                            </select>
                        </div>
                        <div class="mb-6">
