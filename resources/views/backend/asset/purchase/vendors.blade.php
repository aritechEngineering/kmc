    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="px-5">
                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Add Vendor</button>
                </div>
            </div>
                ...
                <table class="dt-responsive table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">ACS15348</td>
                            <td class="text-center">Walton</td>
                            <td class="text-center">AC Supplier</td>
                            <td class="text-center">01717852146, 01513647852</td>
                            <td class="text-center">135/5, South Badda, Gulshan, Dhaka-1000</td>
                            <td class="text-center">Gulshan, Dhaka</td>
                            <td class="text-center">Active</td>
                            <td>
                                <a href="#" class="btn btn-sm btn-success">Edit</a>
                                <a href="#" class="btn btn-sm btn-danger mt-1">Delete</a>
                            </td>
                        </tr>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            <div class="offcanvas-header">
                <h5 id="offcanvasRightLabel" class="offcanvas-title">Add Vendor</h5>
            ...
            <div class="offcanvas-body">
                <form action="" method="">
                    ...
                    <div class="mb-6">
                        <label class="form-label" for="formtabs-country">Sub Category</label>
                        <select id="formtabs-country" class="select2 form-select" data-allow-clear="true">
                            <option value="">Select</option>
                            <option value="Toyota">Light</option>
                            <option value="Bangladesh">Heavy</option>
