    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-header">Vehicle Vendor List</h5>
                <div class="px-5">
            ...
            <div class="card-datatable table-responsive">
                <table class="dt-responsive table">
                    ...
                    <tbody>
                        <tr>
                            <td>01</td>
                            <td class="text-center">Korim Motors</td>
                            <td>
                        ...
                        <tr>
                            <td>02</td>
                            <td class="text-center">Tarek Rent A Car</td>
                            <td>
                                <a href="#" class="btn btn-sm btn-success">Edit</a>
                                <a href="#" class="btn btn-sm btn-success">Delete</a>
                            </td>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            <div class="offcanvas-header py-6">
                <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title">Add Vendor</h5>
