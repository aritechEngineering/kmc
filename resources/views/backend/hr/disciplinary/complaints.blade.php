        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">Complaint Lists</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Complaint</span></span>
                        </button>
                    </div>
                </div>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Complaint</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="Enter Complaint" name="title" aria-label="Department" readonly disabled />
                        </div>
                        <!-- Designation -->
                        <div class="mb-6">
                            <label class="form-label" for="title">Designation</label>
                            <input type="text" class="form-control" id="title" placeholder="Enter Complaint" name="title" aria-label="Designation" readonly disabled />
                        </div>
                        <!-- Employee Against -->
                        <div class="mb-6 ecommerce-select2-dropdown">
                        ...
                        <!-- Complaint Title -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Complaint Title</label>
                            <input type="text" id="dob" class="form-control" value="Complaint Title Enter" />
                        </div>
                        <!-- Complaint Date -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Complaint Date</label>
