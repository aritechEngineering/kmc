        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">Show Cause Lists</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Show Cause</span></span>
                        </button>
                    </div>
                </div>
                    ...
                    <table class="dt-responsive table">
                        <thead>
                            <tr>
                                ...
                                <th>Show Cause Title</th>
                                <th>Response's Last Date</th>
                                <th>Response Letter Date</th>
                                <th>Status</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Show Cause</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <!-- Warning Title -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Show Cause Title</label>
                            <input type="text" id="dob" class="form-control" value="" />
                        </div>
                        <!-- Warning Date -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Show Cause Date</label>
                            <input type="date" id="dob" class="form-control" value="" />
                        </div>
                         <!-- Warning Date -->
                         <div class="mb-6">
                            <label class="form-label" for="dob">Response's Last Date</label>
                            <input type="date" id="dob" class="form-control" value="" />
                        </div>
                        <!-- Description -->
                        <div class="mb-6">
