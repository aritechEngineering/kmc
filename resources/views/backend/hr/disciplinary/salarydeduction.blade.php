        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">List of Salary Subtraction</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Salary Subtraction</span></span>
                        </button>
                    </div>
                </div>
                    ...
                    <table class="dt-responsive table">
                        <thead>
                            <tr>
                                ...
                                <th>Department</th>
                                <th>Designation</th>
                                <th>Subtraction Month</th>
                                <th>Reason of Subtraction</th>
                                <th>Subtraction Amount</th>
                                <th>Status</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody class="table-border-bottom-0">
                            <tr>
                                ...
                                <td>Manager</td>
                                <td>10/06/2024</td>
                                <td>Unofficial behavior.</td>
                                <td>2500</td>
                                <td><span class="badge bg-label-primary me-1">Closed</span></td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-success">Edit</button>
                                    <button type="button" class="btn btn-sm btn-danger mt-1">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                        {{-- <tfoot>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Subtraction</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="form-control" id="title" placeholder="" name="title" aria-label="Department" readonly disabled />
                        </div>
                        <!-- Designation -->
                        <div class="mb-6">
                            <label class="form-label" for="title">Designation</label>
                            <input type="text" class="form-control" id="title" placeholder="" name="title" aria-label="Designation" readonly disabled />
                        </div>
                        <!-- Employee Against -->
                        <div class="mb-6 ecommerce-select2-dropdown">
                        ...
                        <!-- Warning Title -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Reason of Subtraction</label>
                            <input type="text" id="dob" class="form-control" value="" />
                        </div>
                        <!-- Warning Date -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Subtraction Month</label>
                            <input type="date" id="dob" class="form-control" value="" />
                        </div>
                         <!-- Warning Date -->
                         <div class="mb-6">
                            <label class="form-label" for="dob">Subtraction Amount</label>
                            <input type="text" id="dob" class="form-control" value="" />
                        </div>
                        <!-- Description -->
                        <div class="mb-6">
