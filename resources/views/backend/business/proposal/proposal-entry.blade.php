                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <button type="button" class="nav-link active" data-bs-toggle="tab" data-bs-target="#form-tabs-personal" aria-controls="form-tabs-personal" role="tab" aria-selected="true">
                                        ...
                                        <span class="d-none d-sm-block">Proposal Entry</span>
                                    </button>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div data-repeater-list="group-a">
                                        <div data-repeater-item>
                                            <div class="row g-6 py-4">
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label" for="formtabs-first-name">Pre-Bid Meeting Date</label>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="form-label" for="formtabs-first-name">Proposal file location</label>
