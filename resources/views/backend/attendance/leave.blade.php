        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">Leave Lists</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Leave</span></span>
                        </button>
                    </div>
                </div>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Leave</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        ...
                        <div class="mb-6 ecommerce-select2-dropdown">
                            ...
                            <select id="leave_type" class="select2 form-select" data-placeholder="Select Leave Type">
                        ...
                        <div class="mb-6">
                            <label class="form-label" for="dob">Leave Start Date</label>
                            <input type="date" id="dob" class="form-control" value="2021-06-18" />
                        </div>
                        <div class="mb-6">
                            <label class="form-label" for="dob">Leave End Date</label>
                            <input type="date" id="dob" class="form-control" value="2021-06-18" />
                        </div>
                        <div class="mb-6">
                            <label class="form-label" for="title">Total Day</label>
                            <input type="text" class="form-control" id="title" placeholder="Total Day" name="title" readonly disabled />
                        </div>
                        <!-- Remark -->
                        <div class="mb-6">
