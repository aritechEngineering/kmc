        ...
        <div class="app-ecommerce-category">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-header py-3">Holiday Lists</h5>
                    <div class="px-5">
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">
                            <span><i class="ti ti-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Holiday</span></span>
                        </button>
                    </div>
                </div>
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth" aria-labelledby="offcanvasBothLabel">
                <div class="offcanvas-header">
                    <h5 id="" class="offcanvas-title">Add Holiday</h5>
                ...
                <div class="offcanvas-body border-top">
                    <form class="pt-0" id="eCommerceCategoryListForm" onsubmit="return true">
                        <!-- Title -->
                        <div class="mb-6">
                            <label class="form-label" for="title">Holiday</label>
                            <input type="text" class="form-control" id="title" placeholder="Enter Holiday" name="title" aria-label="Holiday title" />
                        </div>
                        <!-- Start Date -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">Start Date</label>
                            <input type="date" id="dob" class="form-control" value="2021-06-18" />
                        </div>
                        <!-- End Date -->
                        <div class="mb-6">
                            <label class="form-label" for="dob">End Date</label>
                            <input type="date" id="dob" class="form-control" value="2021-06-18" />
                        </div>
                        <!-- Remark -->
                        <div class="mb-6">
